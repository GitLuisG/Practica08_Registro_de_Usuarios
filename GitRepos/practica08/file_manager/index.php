...
$archivosDelDirectorio = scandir("../Archivos/");
...
<body>
    <div id="contenedor">
        ...
        <p>Subir archivo:</p>
        <form action="ajax/subir_archivo.php" method="POST" enctype="multipart/form-data">
...
<?php foreach ($archivosPdf as $a) { ?>
                <tr>
                    <td><?=$a?></td>
                    <td><a href="ajax/ver.php?archivo=<?=rawurlencode($a)?>" target="_blank">VER</a></td>
                    <td><a href="ajax/borrar.php?archivo=<?=rawurlencode($a)?>">BORRAR</a></td>
                <tr>
<?php } ?>
            </tbody>
        </table>
